...
const RidePopup = (props) => {
  return (
    <div>
      ...
      }}  className="w-full mb-2 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-all">
        Confirm Ride
      </button>
      <button onClick={()=>{
        props.setRidePopup(false)
      ...
      }}  className="w-full mt-2 py-3 bg-red-300 text-white rounded-lg hover:bg-gray-800 transition-all">
        Ignore
      </button>
    </div>
  )
